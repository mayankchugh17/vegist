...
function Cards() {  
    return (
        <div className="parent animate__animated animate__backInLeft absolute w-full mt-10 md:top-270 z-50 flex flex-col md:flex-row justify-center items-center gap-6 mx-auto">
            <div className="scale-div bg-white p-8 flex text-center flex-col justify-center shadow-xl items-center rounded-lg px-15 md:px-30 gap-4">
