...
function Cards() {  
    return (
        <div className="absolute w-full top-255 z-50 flex flex-col md:flex-row justify-center items-center gap-6 mx-auto">
            <div className="bg-white p-8  flex text-center flex-col justify-center shadow-xl items-center rounded-lg px-10 md:px-30 gap-4">
